...
from app.api.v1 import student_dashboard as student_dashboard_router
...
def create_app() -> FastAPI:
    ...
    app.include_router(student_dashboard_router.router, prefix="/v1/student-dashboard", tags=["Student Dashboard"])
